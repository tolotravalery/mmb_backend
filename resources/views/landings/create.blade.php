        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            {{ Form::open(array('url' => 'landings','enctype'=>'multipart/form-data')) }}
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center title-2">Create Landing</h3>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group {{ $errors->has('date_landing') ? ' has-error' : '' }}">
                                        ...
                                        {!! Form::date('date_landing', NULL, array('class' => 'form-control')) !!}
                                    ...
                                    <div class="form-group {{ $errors->has('image_cn') ? ' has-error' : '' }} ">
                                        ...
                                        <input type="file" id="file-input" name="image_cn" class="form-control-file" required>
                                    ...
                                    <div class="form-group {{ $errors->has('image_en') ? ' has-error' : '' }} ">
                                        ...
                                        <input type="file" id="file-input" name="image_en" class="form-control-file" required>
